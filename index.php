...
$main->mapVia('dpo/ticket/payment', 'dpoPaymentsAction', ['POST']);
...
$dashboard->mapVia('summary', 'summaryDashboardStats', ['POST']);
$dashboard->mapVia('graph', 'dashTicketPurchaseGraph', ['POST']);
$dashboard->mapVia('events/summary', 'summaryEventsTickets', ['POST']);
$dashboard->mapVia('events/show/summary', 'summaryEventsShowTickets', ['POST']);
$dashboard->mapVia('tickets/graph', 'ticketPurchaseGraph', ['POST']);
$dashboard->mapVia('tickets/show/types', 'ticketTypesShowsEvents', ['POST']);
$dashboard->mapVia('tickets/types', 'ticketTypesEvents', ['POST']);
$dashboard->mapVia('customer', 'customersAction', ['POST']);
$dashboard->mapVia('tickets/purchased', 'viewTicketPurchased', ['POST']);
$dashboard->mapVia('view/mpesa', 'viewMpesaDepo', ['POST']);
$dashboard->mapVia('tickets/types/edit', 'editTicketTypes', ['POST']);
$dashboard->mapVia('view/affiliators/events', 'viewAffiliatorSales', ['POST']);
$dashboard->mapVia('generate/report', 'generateEventReports', ['POST']);
$dashboard->mapVia('complimentary/report', 'generateComplimentaryReports', ['POST']);
$dashboard->mapVia('refunded/report', 'generateRefundReports', ['POST']);
