    ...
    public function viewMyPayments() {
        ...
        try {
            ...
            $sql = " SELECT * FROM (SELECT transaction.transaction_id,'M-Pesa' COLLATE utf8mb4_bin"
                    ...
                    . " AS amountPay,CONVERT(mpesa_transaction.mpesa_account USING"
                    . " utf8mb4) COLLATE utf8mb4_bin AS account,mpesa_transaction.mpesa_time"
                    . " AS payDate  from transaction "
                    ...
                    . "dpo_transaction_initiated.transaction_id,'Card' COLLATE "
                    . "utf8mb4_bin AS paymentType,CONVERT(transaction_initiated.extra_data->>'$.unique_id'"
                    . " USING utf8mb4) COLLATE utf8mb4_bin AS unique_reference,"
                    . "CONVERT(dpo_transaction.CCDapproval USING utf8mb4) COLLATE "
                    . "utf8mb4_bin AS pay_receipt,transaction_initiated.extra_data->>'$.amount' "
                    . "AS amountPay,CONVERT(dpo_transaction.account USING utf8mb4) "
                    . "COLLATE utf8mb4_bin AS account,dpo_transaction.created AS payDate "
